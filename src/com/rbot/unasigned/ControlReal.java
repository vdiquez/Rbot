...
public class ControlReal extends JFrame {
    VentanaPanel vp;
    Proto pt;
    ControlChat cch;
    ...
    public ControlReal(ControlChat cch, Proto pt, VentanaPanel vp) {
    ...
    public void main(String[] args) {
        ControlReal cr = new ControlReal(cch, pt, vp);
    }
}
